...
public class ASTGen implements ASTGenConstants {
  ...
  static final public void ACLASS() throws ParseException {
    I();
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 1:
      CURLY();
  ...
  static final public void CURLY() throws ParseException {
    jj_consume_token(1);
    label_2:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
  ...
  static final public void PROTECTION() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 6:
      jj_consume_token(6);
      break;
  ...
  static final public void ALLTYPE() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 6:
    case 7:
    case 8:
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xc0000,0xc0000,0x8,0x2,0x2,0xa,0xc0000,0x20,0x1c0,0x200,0x800,0x1c0,0x100000,};
   }
